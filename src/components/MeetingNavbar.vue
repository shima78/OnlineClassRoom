  ...
  <div id="nav-bar">
    <div id="media-control">
      ...
      <div id="username-box" style="display: flex; justify-content: center; align-items: center;">
        ...
        <div id="username-text" style="display: flex; justify-content: center; align-items: center;">
          <label>{{ this.getUsername() }}</label></div>
      </div>
    ...
    <div id="exit-export">
      ...
      <button id="export-button" class="round-button" @click="output" :disabled="role === 'std'"
              v-if="role === 'owner'">
        <label>Export</label>
      </button>
    </div>
